 ...
 * point, so "restoring" it would install an all-zero Shot[], mapping every
 * button to Convert_Data[0]. Nothing needs restoring anyway; see
 * ReplayPlayer_UnpinConfig() below. */
